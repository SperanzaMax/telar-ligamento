...
### Tabla PRIMARIA — N_common = 10000 (da el veredicto) · † NO extendidas, a su N real: softmax
...
| mix22 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 10000 |
...
- **sin degradación material** (umbral 0.0200, N 2500 → 10000)
- caída media apareada por carga: L96: +0.0000 · L128: +0.0000 · peor +0.0000
...
- **P1.2** (herencia de correctabilidad): T2(C3) − ½T2(C1) − ½T2(C2) = +0.0141 (≥0 ✓).
